<nav class="navbar navbar-expand-lg navbar-light topbar mb-4 static-top shadow" style="background: #D0D7FF">
    <div class="container">
    <a class="navbar-brand" href="/">Satoto Cosmetic</a>
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
                ...
                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        ...
                        <div>
                            <div class="small text-black-500">December 12, 2023</div>
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        ...
                        <div>
                            <div class="small text-black-500">December 7, 2023</div>
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        ...
                        <div>
                            <div class="small text-black-500">December 2, 2023</div>
                            Spending Alert: We've noticed unusually high spending for your account.
                        </div>
                    </a>
                    <a class="dropdown-item text-center small text-black-500" href="#">Show All</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="/dashboard-admin"><i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i> My Dasboard</a></li> 
